...
function MyComponent({ args, disabled, theme }: ComponentProps): ReactElement {
  ...
  const highlightNoteCardStyle = useMemo<React.CSSProperties>(() => {
    return {
      position: "absolute", // ✅ 테이블 안에서 절대 위치
      left: "100%", // ✅ 테이블 오른쪽
      marginLeft: "1rem", // ✅ 간격
      top: highlightNoteTop, // ✅ 강조된 행 위치
      width: "260px",
      borderRadius: 16,
      padding: "1rem 1.1rem",
        ...
        {hasData ? (
          <div style={tableNoteLayoutStyle}>
            <div style={tableSectionStyle}>
              <div style={{ ...tableWrapperStyle, position: "relative" }}>
                ...
                {/* highlightNoteCard를 테이블 wrapper 안쪽에서 absolute로 배치 */}
