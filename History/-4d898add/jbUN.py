...
if __name__ == "__main__":
    ...
    event = my_viewer(
        ...
        error_log_detail=[{"detail": "Select a short log line to view full details."}, {"detail": "Select a short log line to view full details."}, {"detail": "Select a short log line to view full details."}],
