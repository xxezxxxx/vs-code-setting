      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={headerCard}>
            ...
            {/* Filters (always blue focus when interacting) */}
