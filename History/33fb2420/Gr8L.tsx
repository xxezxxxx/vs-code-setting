        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseDown={(e) => {
                (e.currentTarget as HTMLElement).style.border = `1px solid ${accent}`
                ;(e.currentTarget as HTMLElement).style.boxShadow = focusRing(accent, 2)
              }}
              onMouseUp={(e) => {
                (e.currentTarget as HTMLElement).style.border = `1px solid #E7EAF0`
                ;(e.currentTarget as HTMLElement).style.boxShadow = "none"
              }}
            >
              All
