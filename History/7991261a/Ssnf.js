...
const resetZoom = (divId) => {
  ...
  if (chart) {
    ...
    }); // 2. 모든 커서 모드를 비활성화하여 툴박스의 선택이 풀리도록 합니다.
...
    `;
    ...
    // **[제거] 기본 포인터(cursor: 'grab') 강제 지정 제거**
    ...
    const option = {
      ...
      toolbox: {
        ...
        top: 0,
        feature: {
          // **[유지] Pan(이동) 기능을 툴박스에 추가**
          brush: {
            type: ["move"],
            title: { move: "이동" },
            icon: {
              move: "path://M17.5,17.2h5.5V12h-5.5V17.2z M17.5,23.6h5.5V18.4h-5.5V23.6z M17.5,30h5.5v-5.2h-5.5V30z M17.5,36.4h5.5v-5.2h-5.5V36.4z M17.5,42.8h5.5v-5.2h-5.5V42.8z M17.5,49.2h5.5v-5.2h-5.5V49.2z M17.5,55.6h5.5v-5.2h-5.5V55.6z M27,17.2h5.5V12H27V17.2z M27,23.6h5.5V18.4H27V23.6z M27,30h5.5v-5.2H27V30z M27,36.4h5.5v-5.2H27V36.4z M27,42.8h5.5v-5.2H27V42.8z M27,49.2h5.5v-5.2H27V49.2z M27,55.6h5.5v-5.2H27V55.6z M36.5,17.2h5.5V12h-5.5V17.2z M36.5,23.6h5.5V18.4h-5.5V23.6z M36.5,30h5.5v-5.2h-5.5V30z M36.5,36.4h5.5v-5.2h-5.5V36.4z M36.5,42.8h5.5v-5.2h-5.5V42.8z M36.5,49.2h5.5v-5.2h-5.5V49.2z M36.5,55.6h5.5v-5.2h-5.5V55.6z M46,17.2h5.5V12H46V17.2z M46,23.6h5.5V18.4H46V23.6z M46,30h5.5v-5.2H46V30z M46,36.4h5.5v-5.2H46V36.4z M46,42.8h5.5v-5.2H46V42.8z M46,49.2h5.5v-5.2H46V49.2z M46,55.6h5.5v-5.2H46V55.6z M55.5,17.2h5.5V12h-5.5V17.2z M55.5,23.6h5.5V18.4h-5.5V23.6z M55.5,30h5.5v-5.2h-5.5V30z M55.5,36.4h5.5v-5.2h-5.5V36.4z M55.5,42.8h5.5v-5.2h-5.5V42.8z M55.5,49.2h5.5v-5.2h-5.5V49.2z M55.5,55.6h5.5v-5.2h-5.5V55.6z",
            },
          },
          dataZoom: {
      ...
      yAxis: { type: "value" },
      series: seriesData, // dataZoom 컴포넌트 (내부): 휠 확대/축소만 담당 (드래그 이동/확대 모두 비활성화)
      dataZoom: [
        {
          type: "inside",
          xAxisIndex: 0,
          yAxisIndex: false,
          filterMode: "none",
          zoomOnMouseWheel: true, // 휠 Zoom만 허용 // **[핵심 수정] 드래그 이동 완전 비활성화**
    ...
    myChart.on("restore", function () {
      // 초기화 시 모든 커서 모드를 비활성화하여 툴박스의 선택이 풀리도록 함
