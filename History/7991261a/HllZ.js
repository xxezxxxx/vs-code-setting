...
// ===============================================
// 4. 실행 코드: DOM 로드 후 이벤트 리스너 설정 (토글 로직 추가)
// ===============================================
document.addEventListener("DOMContentLoaded", () => {
  // ... (기존 EQP/Data 렌더링 및 선택 로직) ...

  // dataDisplayContainer 변수명을 차트 용도에 맞게 다시 지정
  // (이전 요청에서 제거했지만, DOM 요소를 참조하기 위해 변수명을 남깁니다)
