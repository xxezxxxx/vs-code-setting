...
type Args = {
  ...
  frameHeight?: number; // ✅ iframe 고정 높이(px) - 파이썬에서 제어
...
const MyComponent: React.FC<ComponentProps> = (props) => {
  ...
  // ✅ 프레임 고정 높이: 파이썬에서 넘어온 frameHeight 사용(기본값 720px)
